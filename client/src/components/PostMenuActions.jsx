  ...
  return (
    <div className='flex flex-col '>
      ...
      <div className='flex flex-col gap-2.5' >
        {isPending ? "Loading..." : error ? "Login Please!" : (<div className='flex items-center gap-2 cursor-pointer' onClick={handlesave}>
          <svg
        ...
        {user && (post.user.username === user.username || isAdmin) && (
          <div className='flex items-center gap-2 cursor-pointer' onClick={handleDelete}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 50 50"
              fill="red"
            ...
            <span className='text-red-500 text-sm'>Delete this post</span>
          </div>)}
      </div>
    </div>
  )
